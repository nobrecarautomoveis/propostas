...
/**
 * @fileOverview Summarizes a conversation transcript using AI.
 *
...
const SummarizeConversationInputSchema = z.object({
  transcript: z.string().describe('The transcript of the conversation to summarize.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following conversation transcript in a concise and informative way, highlighting the main points and key topics discussed. The summary should be in Portugues Br.\n\nTranscript: {{{transcript}}}`,
});
